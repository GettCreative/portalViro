...
// import ArchPortal from './portalAR2.js'
import {
  ViroSceneNavigator,
  ViroScene,
  ViroARScene,
...
export default class ARSCENE2 extends Component {
  constructor() {
    super();
  ...
  render() {
    return (
        <ViroPortalScene passable={true} dragType="FixedDistance" >
                  <ViroPortal position={[.9, 0, -1]} scale={[.5, .9, .1]}>
            <Viro3DObject source={require('./portal_archway/portal_archway/portal_archway.vrx')}
              resources={[require('./portal_archway/portal_archway/portal_archway_diffuse.png'),
                          require('./portal_archway/portal_archway/portal_archway_normal.png'),
                          require('./portal_archway/portal_archway/portal_archway_specular.png')]}
              type="VRX"/>
          </ViroPortal>
